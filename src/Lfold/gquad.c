...
#define FOR_EACH_GQUAD(a, b, c, d)                                             \
  for ((a) = (d)-VRNA_GQUAD_MIN_BOX_SIZE + 1; (a) >= (c); (a)--)               \
    for ((b) = (a)+VRNA_GQUAD_MIN_BOX_SIZE - 1;                                \
         (b) <= MIN2((d), (a)+VRNA_GQUAD_MAX_BOX_SIZE - 1); (b)++)
...
#define FOR_EACH_GQUAD_AT(a, b, c)                                             \
  for ((b) = (a)+VRNA_GQUAD_MIN_BOX_SIZE - 1;                                  \
       (b) <= MIN2((c), (a)+VRNA_GQUAD_MAX_BOX_SIZE - 1); (b)++)
 ...
 */
PRIVATE
void process_gquad_enumeration(int *gg, int i, int j,
                               void (*f)(int, int, int *, void *, void *,
                                         void *, void *),
                               void *data, void *P, void *aux1, void *aux2);

/**
 *  MFE callback for process_gquad_enumeration()
 */
PRIVATE
void gquad_mfe(int i, int L, int *l, void *data, void *P, void *NA, void *NA2);

PRIVATE
void gquad_mfe_pos(int i, int L, int *l, void *data, void *P, void *Lmfe,
                   void *lmfe);

PRIVATE
void gquad_pos_exhaustive(int i, int L, int *l, void *data, void *P, void *Lex,
                          void *lex);
 ...
 */
PRIVATE
void gquad_pf(int i, int L, int *l, void *data, void *P, void *NA, void *NA2);
 ...
 */
PRIVATE
void gquad_pf_pos(int i, int L, int *l, void *data, void *pf, void *Lmax,
                  void *lmax);
 ...
 */
PRIVATE
void gquad_mfe_ali(int i, int L, int *l, void *data, void *P, void *S,
                   void *n_seq);
 ...
 */
PRIVATE
void gquad_mfe_ali_en(int i, int L, int *l, void *data, void *P, void *S,
                      void *n_seq);

PRIVATE
void gquad_interact(int i, int L, int *l, void *data, void *pf, void *index,
                    void *NA2);

PRIVATE
void gquad_count(int i, int L, int *l, void *data, void *NA, void *NA2,
                 void *NA3);

PRIVATE
void gquad_count_layers(int i, int L, int *l, void *data, void *NA, void *NA2,
                        void *NA3);

/* other useful static functions */

PRIVATE
int gquad_ali_penalty(int i, int L, int l[3], const short **S, paramT *P);
...
PUBLIC int E_gquad(int L, int l[3], paramT *P) {
  ...
  gquad_mfe(0, L, l, (void *)(&c), (void *)P, NULL, NULL);
  return c;
}

PUBLIC FLT_OR_DBL exp_E_gquad(int L, int l[3], pf_paramT *pf) {
  ...
  gquad_pf(0, L, l, (void *)(&q), (void *)pf, NULL, NULL);
  return q;
}

PUBLIC int E_gquad_ali(int i, int L, int l[3], const short **S, int n_seq,
                       paramT *P) {
...
PUBLIC void E_gquad_ali_en(int i, int L, int l[3], const short **S, int n_seq,
                           int en[2], paramT *P) {
  ...
  gquad_mfe_ali_en(i, L, l, (void *)(&(en[0])), (void *)P, (void *)S,
                   (void *)(&n_seq));
}
...
PUBLIC int *get_gquad_matrix(short *S, paramT *P) {
  ...
  FOR_EACH_GQUAD(i, j, 1, n) {
    process_gquad_enumeration(gg, i, j, &gquad_mfe,
                              (void *)(&(data[my_index[j] + i])), (void *)P,
                              NULL, NULL);
  }
...
PUBLIC FLT_OR_DBL *get_gquad_pf_matrix(short *S, FLT_OR_DBL *scale,
  ...
  FOR_EACH_GQUAD(i, j, 1, n) {
    process_gquad_enumeration(gg, i, j, &gquad_pf,
                              (void *)(&(data[my_index[i] - j])), (void *)pf,
                              NULL, NULL);
...
PUBLIC int *get_gquad_ali_matrix(short *S_cons, short **S, int n_seq,
                                 paramT *P) {
  ...
  FOR_EACH_GQUAD(i, j, 1, n) {
    process_gquad_enumeration(gg, i, j, &gquad_mfe_ali,
                              (void *)(&(data[my_index[j] + i])), (void *)P,
                              (void *)S, (void *)(&n_seq));
  }
...
PUBLIC int **get_gquad_L_matrix(short *S, int start, int maxdist, int n,
                                int **g, paramT *P) {
  ...
  if (g) { /* we just update the gquadruplex contribution for the current
    ...
    */
    FOR_EACH_GQUAD_AT(start, j, start + maxdist + 4) {
      process_gquad_enumeration(gg, start, j, &gquad_mfe,
                                (void *)(&(data[start][j - start])), (void *)P,
                                NULL, NULL);
    }
...
PUBLIC void get_gquad_pattern_mfe(short *S, int i, int j, paramT *P, int *L,
                                  int l[3]) {

  int *gg = get_g_islands_sub(S, i, j);
  int c = INF;

  process_gquad_enumeration(gg, i, j, &gquad_mfe_pos, (void *)(&c), (void *)P,
                            (void *)L, (void *)l);
...
PUBLIC void get_gquad_pattern_exhaustive(short *S, int i, int j, paramT *P,
                                         int *L, int *l, int threshold) {

  int *gg = get_g_islands_sub(S, i, j);

  process_gquad_enumeration(gg, i, j, &gquad_pos_exhaustive,
                            (void *)(&threshold), (void *)P, (void *)L,
                            (void *)l);
...
PUBLIC void get_gquad_pattern_pf(short *S, int i, int j, pf_paramT *pf, int *L,
                                 int l[3]) {

  int *gg = get_g_islands_sub(S, i, j);
  FLT_OR_DBL q = 0.;

  process_gquad_enumeration(gg, i, j, &gquad_pf_pos, (void *)(&q), (void *)pf,
                            (void *)L, (void *)l);
...
PUBLIC plist *get_plist_gquad_from_pr(short *S, int gi, int gj, FLT_OR_DBL *G,
                                      FLT_OR_DBL *probs, FLT_OR_DBL *scale,
                                      pf_paramT *pf) {
...
PUBLIC plist *get_plist_gquad_from_pr_max(short *S, int gi, int gj,
                                          FLT_OR_DBL *G, FLT_OR_DBL *probs,
                                          FLT_OR_DBL *scale, int *Lmax,
                                          int lmax[3], pf_paramT *pf) {
  ...
  process_gquad_enumeration(gg, gi, gj, &gquad_interact, (void *)tempprobs,
                            (void *)pf, (void *)my_index, NULL);

  pp = 0.;
  process_gquad_enumeration(gg, gi, gj, &gquad_pf_pos, (void *)(&pp),
                            (void *)pf, (void *)Lmax, (void *)lmax);
...
PUBLIC int get_gquad_count(short *S, int i, int j) {

  int *gg = get_g_islands_sub(S, i, j);
  int p, q, counter = 0;

  FOR_EACH_GQUAD(p, q, i, j)
  process_gquad_enumeration(gg, p, q, &gquad_count, (void *)(&counter), NULL,
                            NULL, NULL);
...
PUBLIC int get_gquad_layer_count(short *S, int i, int j) {

  int *gg = get_g_islands_sub(S, i, j);
  int p, q, counter = 0;

  FOR_EACH_GQUAD(p, q, i, j)
  process_gquad_enumeration(gg, p, q, &gquad_count_layers, (void *)(&counter),
                            NULL, NULL, NULL);
...
PRIVATE int gquad_ali_penalty(int i, int L, int l[3], const short **S,
                              paramT *P) {
...
PRIVATE void gquad_mfe(int i, int L, int *l, void *data, void *P, void *NA,
                       void *NA2) {
...
PRIVATE void gquad_mfe_pos(int i, int L, int *l, void *data, void *P,
                           void *Lmfe, void *lmfe) {
...
PRIVATE void gquad_pf(int i, int L, int *l, void *data, void *pf, void *NA,
                      void *NA2) {

  *((FLT_OR_DBL *)data) += ((pf_paramT *)pf)->expgquad[L][l[0] + l[1] + l[2]];
}

PRIVATE void gquad_pf_pos(int i, int L, int *l, void *data, void *pf,
                          void *Lmax, void *lmax) {
...
PRIVATE void gquad_mfe_ali(int i, int L, int *l, void *data, void *P, void *S,
                           void *n_seq) {
...
PRIVATE void gquad_mfe_ali_en(int i, int L, int *l, void *data, void *P,
                              void *S, void *n_seq) {
...
PRIVATE void gquad_interact(int i, int L, int *l, void *data, void *pf,
                            void *index, void *NA2) {
  ...
  for (x = 0; x < L; x++) {
    ...
    pp[idx[i + x + 2 * L + l[0] + l[1]] -
       (i + x + 3 * L + l[0] + l[1] + l[2])] += gq;
  }
}
    ...
    for (L = MIN2(gg[i], VRNA_GQUAD_MAX_STACK_SIZE);
      ...
      if (gg[j - L + 1] >= L) {
        ...
        if ((max_linker >= 3 * VRNA_GQUAD_MIN_LINKER_LENGTH) &&
          ...
          for (l[0] = VRNA_GQUAD_MIN_LINKER_LENGTH; l[0] <= maxl0; l[0]++)
            if (gg[i + L + l[0]] >= L) {
              maxl1 = MIN2(VRNA_GQUAD_MAX_LINKER_LENGTH,
                           max_linker - l[0] - VRNA_GQUAD_MIN_LINKER_LENGTH);
              for (l[1] = VRNA_GQUAD_MIN_LINKER_LENGTH; l[1] <= maxl1; l[1]++)
