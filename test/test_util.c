...
void test_config_parsing(struct test *t) {
  ...
  t_log(t, "min_mature_strand_length %d\n", config->min_mature_strand_length);
  t_log(t, "max_mature_strand_length %d\n", config->max_mature_strand_length);
  ...
  t_assert_msg(t, config->min_mfe_per_nt == -0.24, "min_mfe_per_nt wrong");
  ...
  t_assert_msg(t, config->min_mature_strand_length == -45,
               "min_mature_strand_length wrong");
  t_assert_msg(t, config->max_mature_strand_length == -46,
               "max_mature_strand_length wrong");
