...
START_TEST (test_valid_line)
{
    ...
    int result = parse_line(&test_entry,sample_line,1000);
...
START_TEST (test_header_line)
{
    ...
    struct sam_entry test_entry;
    int result = parse_line(&test_entry,sample_line,100);
...
{
    char sample_line[1000]="Seq23599_x1	272	scaffold_1	6a7	0	21M	*	0	0	GCCACCCATGCCGCATCCACA	IIIIIIIIIIIIIIIIIIIII	AS:i:-6	XN:i:0	XM:i:1	XO:i:0	XG:i:0	NM:i:1	MD:Z:12A8	YT:Z:UU	NH:i:16	CC:Z:=	CP:i:250	HI:i:0";
    struct sam_entry test_entry;
    int result = parse_line(&test_entry,sample_line,1000);
